  ...
  return (
    <section id="fees" className="py-20 bg-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-20">
        <div className="bg-green-200 rounded-lg p-4 sm:p-6 md:p-8">
          <div className="text-center space-y-4 mb-12">
            <h3 className="text-2xl md:text-3xl font-serif text-blue-900">
              ...
              <CardContent className="p-0">
                <Accordion type="single" collapsible className="w-full">
                  {faqs.map((faq, idx) => (
                    ...
                    >
                      <AccordionTrigger
                        className="px-4 sm:px-8 py-5 text-left bg-white hover:bg-blue-100 focus:bg-blue-200 transition rounded-t-xl outline-none group"
                        style={{ borderRadius: idx === 0 ? '0.75rem 0.75rem 0 0' : undefined }}
                      >
                        <span className="text-base sm:text-lg md:text-xl font-semibold text-blue-900 group-hover:text-blue-500 transition">
                          {faq.question}
                        </span>
                      </AccordionTrigger>
                      <AccordionContent className="px-4 sm:px-8 pb-6 pt-2 bg-white text-blue-700 rounded-b-xl">
