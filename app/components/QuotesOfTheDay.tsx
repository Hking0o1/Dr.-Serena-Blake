...
const QuotesOfTheDay: React.FC = () => {
  ...
  return (
    <div
      className="relative  shadow-lg overflow-hidden min-h-[220px] sm:min-h-[300px] flex items-center justify-center "
      style={{
    ...
    >
      ...
      <div className="relative z-10 p-4 sm:p-8 max-w-xl text-center text-white">
        <h2 className="italic text-lg sm:text-2xl md:text-3xl mb-2 sm:mb-4 font-semibold">
          &quot;{quote.text}&quot;
        </h2>
        <p className="font-bold text-base sm:text-lg">- {quote.author}</p>
      </div>
    </div>
  );
};
